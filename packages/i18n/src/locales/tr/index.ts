...
export const tr = {
  ...
  chat: {
    addFilesOption: "Dosyalar",
    addMediaOption: "Fotoğraflar ve Medya",
    ...
    fallbackLocal: "{{provider}} sağlayıcısına geç ve tekrar dene",
  ...
  plan: {
    openWorkspaceRequired: "Planı yürütmek için çalışma alanı klasörü gereklidir.",
...
sklm: {
    ...
    general: "Genel",
    ai: "AI",
    usages: "Token Kullanımı",
    usageActivity: "Etkinlik Haritası",
    usageTotal: "Toplam",
    usageInput: "Girdi",
    usageOutput: "Çıktı",
    usageTurns: "Tur",
    usageLess: "Daha az",
    usageMore: "Daha çok",
    usageEmpty: "Henüz kaydedilmiş token kullanımı yok",
    usageLoadError: "Kullanım yüklenemedi",
    usageRefresh: "Yenile",
    usageMon: "Pzt",
    usageWed: "Çar",
    usageFri: "Cum",
    usageCell: "{{date}}: {{total}} token",
    usageTimeframes: "Zaman Dilimine Göre Kullanım",
    usageModels: "Modele Göre Kullanım",
    usageToday: "Bugün",
    usage7Days: "7 Gün",
    usage1Month: "1 Ay",
    usage2Months: "2 Ay",
    usageAllTime: "Tüm Zamanlar",
    usageCostUsd: "Maliyet (USD)",
    usageModelName: "Model",
    usageRate: "Tarife ($/1M)",
    usageTableTimeframe: "Zaman Dilimi",
    usageTableInput: "Girdi Tokenları",
    usageTableOutput: "Çıktı Tokenları",
    usageTableTotal: "Toplam Token",
    usageTableCost: "Toplam Maliyet (USD)",
    usageActiveModel: "Aktif Model",
    usageTopModels: "En Çok Kullanılan Modeller",
    usageInputTokens: "Girdi Tokenları",
    usageCacheTokens: "Önbellek Tokenları",
    usageOutputTokens: "Çıktı Tokenları",
    usageTotalCost: "Toplam Maliyet",
    usageStatusActive: "Aktif",
    sessionTokensTitle: "Oturum Token Ayrıntıları",
    sessionTokensCache: "Önbellek Okuma",
    sessionTokensInput: "Girdi Tokenları",
    sessionTokensOutput: "Çıktı Tokenları",
    sessionTokensReasoning: "Akıl Yürütme",
    sessionTokensTotal: "Toplam Harcanan",
    sessionTokensCost: "Tahmini Maliyet",
    shortcuts: "Kısayollar",
    instructions: "Yönergeler",
    ...
    exportSkill: "Markdown (.md) Olarak Dışa Aktar",
    copySkillMarkdown: "Markdown'ı Kopyala",
    importSkillUrl: "URL'den İçe Aktar",
    ...
    apiKeyLocalOptional: "Yerel uç noktalar için isteğe bağlı",
    apiKeyNoneRequired: "Gerekli değil (yerel uç nokta)",
    usageRefreshed: "Kullanım verileri yenilendi",
    usageRefreshFailed: "Kullanım verileri yenilenemedi",
    quotaRefreshed: "Kota güncellendi",
    quotaLocked: "0% (Kilitli / Tükendi)",
    quotaRemaining: "%{{percent}} kaldı",
    quotaResetsIn: "{{duration}} içinde sıfırlanır",
    quotaActive: "Etkin",
    permissionAskHint: "Araçlar/düzenlemelerden önce her zaman onay iste",
    permissionAcceptEditsHint: "Dosya düzenlemelerini otomatik kabul et, komutlar için sor",
    permissionAutoHint: "İstemleri atla ve otonom olarak çalıştır",
    modeAgentDesc: "Tam yetenekli otonom kodlama aracısı",
    modePlanDesc: "İnceleme için uygulama planları oluşturun",
    modeGoalDesc: "Otomatik onaylarla hedefe yönelik yürütme",
  ...
  search: {
    quickOpenPlaceholder: "Açmak için bir dosya adı yazın…",
    noFilesFound: "Sorguyla eşleşen dosya yok.",
...
importConfirm: "İçe aktarılan uzantılar ajan sürecinde, ajanın kendi araçlarıyla aynı erişimle çalışır. Bildirilen beceriler ajana talimatlar ekleyebilir ve bildirilen bağımlılıklar npm ile yüklenir (yükleme betikleri devre dışı). Devam edilsin mi?",
  ...
  git: {
    messageGenerated: "İşleme mesajı oluşturuldu!",
    commitSuccess: "Başarıyla işlendi!",
    notRepo: "Git Deposu Değil",
    notRepoHint: "Geçerli çalışma alanı klasörü Git tarafından izlenmiyor.",
    cleanTitle: "Çalışma Ağacı Temiz",
    cleanHint: "Çalışma alanında aşamalanmamış veya izlenmeyen değişiklik yok.",
    changedFiles: "{{count}} dosya değiştirildi",
    stageAll: "Tümünü Aşamala",
    stage: "Aşamala",
    stageHunk: "Bloğu Aşamala",
    discardHunk: "Bloğu Geri Al",
    untrackedEmpty: "Yeni izlenmeyen dosya",
    noHunks: "İkili veya boş değişiklikler",
    commitMessageLabel: "İşleme Mesajı:",
    commitPlaceholder: "type(scope): mesaj konusu…",
    generateAiCommit: "Yapay Zeka İşlemesi",
    commit: "İşle",
  },
  workpanel: {
    openFolderPrompt: "Lütfen bir proje klasörü açın",
    todosCreatedFromPlan: "Plandan Yapılacaklar listesine {{count}} görev oluşturuldu!",
    openFolderToExecutePlan: "Planı onaylamak ve yürütmek için lütfen bir proje klasörü açın.",
    openFolderToCreatePlan: "Plan oluşturmadan önce lütfen bir proje klasörü açın.",
    openFolderToCreatePlanRequired: "Plan oluşturmak için lütfen bir proje klasörü açın.",
    selectPlanTooltip: "~/.pi-desktop/plans/ dizininden plan seçin",
    syncTodosFromPlanTooltip: "Bu plandan Yapılacaklar listesini senkronize et",
    createPlanTooltip: "Yeni plan oluştur",
    createPlan: "Plan Oluştur",
    planAnswerInstructions: "Cevap / Talimatlar:",
    planAnswerPlaceholder: "Planı onaylamadan önce cevapları veya ek talimatları girin…",
    autoAcceptEditsTooltip: "Plan yürütülürken düzenlemeleri otomatik kabul et",
    noApprovalTooltip: "Onay olmadan tam otomatik çalıştır (Onay Yok)",
    askEachStepTooltip: "Her adımdan önce sor",
    createNewPlanTitle: "Yeni Plan Oluştur",
    createNewPlanDesc: "Dosyaları düzenlemeden önce teknik adımları ~/.pi-desktop/plans/ içine planlayın.",
    planRequirementsLabel: "Plan için Gereksinimler / Cevaplar:",
    planRequirementsPlaceholder: "Planlanacak gereksinimleri girin, örn. \"Kimlik doğrulamayı yeniden düzenle\"",
    createPlanAutoAcceptTooltip: "Düzenlemeleri Otomatik Kabul modunda plan oluştur",
    createPlanNoApproveTooltip: "Onaysız (otomatik) modda plan oluştur",
    viewSavedPlans: "Kayıtlı planları görüntüle",
  },
