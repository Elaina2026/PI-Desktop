...
export const zhCN = {
  ...
  chat: {
    ...
    fallbackLocal: "切换至 {{provider}} 并重试",
    editMessage: "编辑并重新发送",
    cancelEdit: "取消",
    retryEdit: "重试",
    retryingEdit: "重试中…",
  ...
  plan: {
    openWorkspaceRequired: "执行计划需要先打开工作区文件夹。",
...
sklm: {
    ...
    usageTimeframes: "各时间段用量与总价",
    usageModels: "各模型用量与费用",
    usageToday: "今天",
    usage7Days: "7 天",
    usage1Month: "1 个月",
    usage2Months: "2 个月",
    ...
    usageModelName: "模型",
    usageRate: "费率 ($/1M)",
    usageTableTimeframe: "时间跨度",
    usageTableInput: "输入 Token",
    usageTableOutput: "输出 Token",
    usageTableTotal: "总 Token",
    usageTableCost: "总费用 (USD)",
    usageActiveModel: "当前模型",
    usageTopModels: "热门模型",
    usageInputTokens: "输入 Token",
    usageCacheTokens: "缓存 Token",
    usageOutputTokens: "输出 Token",
    usageTotalCost: "总费用",
    usageStatusActive: "运行中",
    sessionTokensTitle: "会话 Token 详情",
    sessionTokensCache: "缓存读取",
    sessionTokensInput: "输入 Token",
    sessionTokensOutput: "输出 Token",
    sessionTokensReasoning: "思考推理",
    sessionTokensTotal: "累计消耗",
    sessionTokensCost: "预估费用",
    shortcuts: "快捷键",
    instructions: "指令",
    ...
    skillSaved: "已保存 {{name}}",
    exportSkill: "导出 Markdown (.md)",
    copySkillMarkdown: "复制 Markdown",
    importSkillUrl: "从 URL 导入",
    ...
    apiKeyLocalOptional: "本地端点可选",
    apiKeyNoneRequired: "无需密钥（本地端点）",
    usageRefreshed: "用量数据已刷新",
    usageRefreshFailed: "刷新用量数据失败",
    quotaRefreshed: "配额已更新",
    quotaLocked: "0% (已锁定 / 已耗尽)",
    quotaRemaining: "剩余 {{percent}}%",
    quotaResetsIn: "{{duration}} 后重置",
    quotaActive: "正常",
    permissionAskHint: "在执行工具/编辑前始终请求确认",
    permissionAcceptEditsHint: "自动接受文件编辑，命令执行前询问",
    permissionAutoHint: "跳过确认提示，全自主执行",
    modeAgentDesc: "具备全功能的自主编码代理",
    modePlanDesc: "制定实现计划供审核",
    modeGoalDesc: "目标驱动的执行与自动化审批",
  ...
  git: {
    messageGenerated: "提交说明已生成！",
    commitSuccess: "提交成功！",
    notRepo: "非 Git 仓库",
    notRepoHint: "当前工作区文件夹未受 Git 跟踪。",
    cleanTitle: "工作区干净",
    cleanHint: "工作区中没有未暂存或未跟踪的更改。",
    changedFiles: "{{count}} 个文件已修改",
    stageAll: "暂存全部",
    stage: "暂存",
    stageHunk: "暂存代码块",
    discardHunk: "丢弃代码块",
    untrackedEmpty: "新增未跟踪空文件",
    noHunks: "二进制或空变更",
    commitMessageLabel: "提交说明：",
    commitPlaceholder: "type(scope): 提交标题…",
    generateAiCommit: "AI 提交",
    commit: "提交",
  },
  workpanel: {
    openFolderPrompt: "请打开项目文件夹",
    todosCreatedFromPlan: "已从计划创建 {{count}} 个任务到待办列表！",
    openFolderToExecutePlan: "请打开项目文件夹以审批和执行计划。",
    openFolderToCreatePlan: "创建计划前请打开项目文件夹。",
    openFolderToCreatePlanRequired: "请打开项目文件夹以创建计划。",
    selectPlanTooltip: "从 ~/.pi-desktop/plans/ 选择计划",
    syncTodosFromPlanTooltip: "从此计划同步待办列表",
    createPlanTooltip: "创建新计划",
    createPlan: "创建计划",
    planAnswerInstructions: "回复 / 附加说明：",
    planAnswerPlaceholder: "在审批计划前输入要求或附加指示…",
    autoAcceptEditsTooltip: "执行计划时自动接受文件编辑",
    noApprovalTooltip: "无需审批全自动运行（免审批）",
    askEachStepTooltip: "每步执行前进行询问",
    createNewPlanTitle: "创建新计划",
    createNewPlanDesc: "在修改文件前制定技术规划至 ~/.pi-desktop/plans/。",
    planRequirementsLabel: "计划要求 / 说明：",
    planRequirementsPlaceholder: "输入计划的具体要求，例如“重构认证模块”",
    createPlanAutoAcceptTooltip: "以自动接受编辑模式创建计划",
    createPlanNoApproveTooltip: "以免审批模式创建计划",
    viewSavedPlans: "查看已保存计划",
  },
