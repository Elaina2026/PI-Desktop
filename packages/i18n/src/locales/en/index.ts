export const en = {
  ...
  chat: {
    addFilesOption: "Files",
    addMediaOption: "Photos & Media",
    ...
    fallbackLocal: "Switch to {{provider}} & Retry",
...
sklm: {
    ...
    exportSkill: "Export Markdown (.md)",
    copySkillMarkdown: "Copy Markdown",
    importSkillUrl: "Import from URL",
    ...
    quotaRefreshed: "Quota updated",
    quotaLocked: "0% (Locked / Exhausted)",
    quotaRemaining: "{{percent}}% remaining",
    quotaResetsIn: "Resets in {{duration}}",
    quotaActive: "Active",
...
importConfirm: "Imported extensions run inside the agent process with the same access as the agent's own tools. Declared skills can add instructions to the agent, and declared dependencies are installed with npm (install scripts disabled). Continue?",
  ...
  git: {
    ...
    notRepoHint: "The current workspace folder is not tracked by Git.",
    cleanTitle: "Working Tree Clean",
    cleanHint: "No unstaged or untracked changes in the workspace.",
    changedFiles: "{{count}} file(s) modified",
    stageAll: "Stage All",
    stage: "Stage",
    stageHunk: "Stage Hunk",
    discardHunk: "Discard Hunk",
    untrackedEmpty: "New untracked file",
    noHunks: "Binary or empty changes",
    commitMessageLabel: "Commit Message:",
    commitPlaceholder: "type(scope): message subject…",
    generateAiCommit: "AI Commit",
    commit: "Commit",
  },
  workpanel: {
    openFolderPrompt: "Please open a project folder",
