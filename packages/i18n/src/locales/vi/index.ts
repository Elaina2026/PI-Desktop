...
export const vi = {
  ...
  chat: {
    ...
    quickActionOpenProject: "Mở một dự án",
    emptyHint: "Thêm nhà cung cấp AI và mở một dự án để bắt đầu.",
    placeholder: "Yêu cầu PI-Desktop hỗ trợ mọi tác vụ",
    ...
    addPhotos: "Thêm ảnh",
    captureAppshot: "Chụp ảnh màn hình",
    ...
    appshotSoon: "Tính năng chụp màn hình sẽ sớm ra mắt",
    slashMenu: "Lệnh",
...
sklm: {
    ...
    apiKeyLocalOptional: "Optional for local endpoints",
    apiKeyNoneRequired: "None required (local endpoint)",
    usageRefreshed: "Usage data refreshed",
    usageRefreshFailed: "Failed to refresh usage data",
    ...
    permissionAskHint: "Always ask for confirmation before tools/edits",
    permissionAcceptEditsHint: "Automatically accept file edits, ask for commands",
    permissionAutoHint: "Bypass prompts and execute autonomously",
    modeAgentDesc: "Autonomous coding agent with full capability",
    modePlanDesc: "Formulate implementation plans for review",
    modeGoalDesc: "Goal-directed execution with automated approvals",
  ...
  search: {
    quickOpenPlaceholder: "Type a file name to open…",
    noFilesFound: "No files matching query.",
