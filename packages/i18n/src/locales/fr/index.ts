...
export const fr = {
  ...
  "chat": {
    ...
    "fallbackLocal": "Basculer vers {{provider}} et réessayer",
...
sklm: {
    ...
    "general": "Général",
    "ai": "AI",
    "usages": "Utilisation des jetons",
    "usageActivity": "Carte d'activité",
    "usageTotal": "Total",
    "usageInput": "Entrée",
    "usageOutput": "Sortie",
    "usageTurns": "Tours",
    "usageLess": "Moins",
    "usageMore": "Plus",
    "usageEmpty": "Aucune utilisation enregistrée pour le moment",
    "usageLoadError": "Impossible de charger l'utilisation",
    "usageRefresh": "Actualiser",
    "usageMon": "Lun",
    "usageWed": "Mer",
    "usageFri": "Ven",
    "usageCell": "{{date}} : {{total}} jetons",
    "usageTimeframes": "Utilisation par période",
    "usageModels": "Utilisation par modèle",
    "usageToday": "Aujourd'hui",
    "usage7Days": "7 jours",
    "usage1Month": "1 mois",
    "usage2Months": "2 mois",
    "usageAllTime": "Tout le temps",
    "usageCostUsd": "Coût (USD)",
    "usageModelName": "Modèle",
    "usageRate": "Tarif ($/1M)",
    "usageTableTimeframe": "Période",
    "usageTableInput": "Jetons d'entrée",
    "usageTableOutput": "Jetons de sortie",
    "usageTableTotal": "Jetons totaux",
    "usageTableCost": "Coût total (USD)",
    "usageActiveModel": "Modèle actif",
    "usageTopModels": "Meilleurs modèles",
    "usageInputTokens": "Jetons d'entrée",
    "usageCacheTokens": "Jetons de cache",
    "usageOutputTokens": "Jetons de sortie",
    "usageTotalCost": "Coût total",
    "usageStatusActive": "Actif",
    "sessionTokensTitle": "Détails des jetons de session",
    "sessionTokensCache": "Lecture du cache",
    "sessionTokensInput": "Jetons d'entrée",
    "sessionTokensOutput": "Jetons de sortie",
    "sessionTokensReasoning": "Raisonnement",
    "sessionTokensTotal": "Total consommé",
    "sessionTokensCost": "Coût estimé",
    "shortcuts": "Raccourcis",
    "instructions": "Instructions",
    ...
    "shortcutAction": {
      ...
      "toggleSidebar": "Basculer la barre latérale",
      "openWorkPanel": "Basculer le panneau de travail",
    ...
    "exportSkill": "Exporter en Markdown (.md)",
    "copySkillMarkdown": "Copier le Markdown",
    "importSkillUrl": "Importer depuis une URL",
    ...
    "quotaLocked": "0% (Verrouillé / Épuisé)",
    "quotaRemaining": "{{percent}}% restant",
    "quotaResetsIn": "Réinitialisation dans {{duration}}",
    "quotaActive": "Actif",
  ...
  "project": {
    ...
    "editInstructions": "Modifier AGENTS.md",
    "instructionsSaved": "AGENTS.md enregistré",
