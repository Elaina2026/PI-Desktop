...
export const IPC = {
  invoke: {
    ...
    planListFiles: "pi-desktop/plans/listFiles",
    planReadFile: "pi-desktop/plans/readFile",
    planSaveFile: "pi-desktop/plans/saveFile",
    memoryGet: "pi-desktop/memory/get",
    memoryRemember: "pi-desktop/memory/remember",
    memoryForget: "pi-desktop/memory/forget",
